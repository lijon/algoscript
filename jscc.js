...
{
	imports.platform.quit( exitcode );
}
...
/*	var f = new java.io.PrintWriter( file );
	...
	*/
	Gio.simple_write(file, content);
	return true;
}

var args_global_var = [];

var _argv = imports.platform.argv;
for(var i=2;i<_argv.length;i++) { args_global_var.push(_argv[i])}
